...
const API_ACCOUNT_BALANCE_ADJUSTMENTS_PATH = `${API_V1_PREFIX}/account-balance-adjustments`;
...
const API_SUPPLIER_REFUNDS_PATH = `${API_V1_PREFIX}/supplier-refunds`;
const API_SUPPLIER_BALANCE_ADJUSTMENTS_PATH = `${API_V1_PREFIX}/supplier-balance-adjustments`;
...
const API_CUSTOMER_LOANS_PATH = `${API_V1_PREFIX}/customer-loans`;
const API_CUSTOMER_LOAN_REPAYMENTS_PATH = `${API_V1_PREFIX}/customer-loan-repayments`;
const API_CUSTOMER_BALANCE_ADJUSTMENTS_PATH = `${API_V1_PREFIX}/customer-balance-adjustments`;
