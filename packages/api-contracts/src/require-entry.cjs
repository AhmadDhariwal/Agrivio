...
const API_AUTH_NAVIGATION_PREFERENCES_PATH = `${API_V1_PREFIX}/auth/navigation-preferences`;
...
const API_ACCOUNTS_SUMMARY_PATH = `${API_V1_PREFIX}/accounts/summary`;
...
const API_PAYMENTS_PATH = `${API_V1_PREFIX}/payments`;
...
const API_PLATFORM_AUDIT_RETENTION_PATH = `${API_V1_PREFIX}/platform/audit-retention`;
...
const API_SUBSCRIPTION_BILLING_EVIDENCE_PATH = `${API_V1_PREFIX}/subscription/billing-evidence`;
