...
* Organization Capability & UI Policy implementation complete for the generic foundation plus Products, Categories, Inventory / Stock-on-Hand, and Opening Stock modules — see [tasks/ORGANIZATION-CAPABILITY-PHASE-1.md](tasks/ORGANIZATION-CAPABILITY-PHASE-1.md)
...
| [tasks/ORGANIZATION-CAPABILITY-PHASE-1.md](tasks/ORGANIZATION-CAPABILITY-PHASE-1.md) | Organization Capability & UI Policy generic foundation plus Products, Categories, Inventory / Stock-on-Hand, and Opening Stock integrations (complete) |
