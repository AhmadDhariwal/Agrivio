...
| `DOMAIN_GLOSSARY.md` | Domain terms and definitions |
| `ARCHITECTURE.md` | System architecture overview |
| `FRONTEND_ARCHITECTURE.md` | Frontend architecture |
| `BACKEND_ARCHITECTURE.md` | Backend architecture |
| `FILE_STRUCTURE.md` | Repository and module layout |
| `DATA_MODEL.md` | Data model |
| `API_CONVENTIONS.md` | API conventions |
| `SECURITY_RULES.md` | Security rules |
| `SUBSCRIPTION_AND_BILLING.md` | Subscription and billing detail |
