...
* F09 Phase 2 **partial**: `R1-F09-002` complete (REL-G03/REL-G05); `R1-F09-003` complete (REL-G04) and F09-003-M1/M2/M3 Frozen HTTP gaps closed; `R1-F09-004` not accepted — see [tasks/F09-PHASE-2-SECURITY-PERF-A11Y.md](tasks/F09-PHASE-2-SECURITY-PERF-A11Y.md)
...
* Next work item: `R1-F09-004` — F09 is **not** complete
...
| [tasks/F09-PHASE-2-SECURITY-PERF-A11Y.md](tasks/F09-PHASE-2-SECURITY-PERF-A11Y.md) | F09 Phase 2: `R1-F09-002`/`003` complete; `R1-F09-004` Frozen DoD not accepted |
