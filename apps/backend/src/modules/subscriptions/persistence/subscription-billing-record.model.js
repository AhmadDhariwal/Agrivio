...
const subscriptionBillingRecordSchema = new mongoose.Schema(
  {
    ...
    evidenceUploadedAt: { type: Date, default: null },
    listedMonthlyPriceMinorUnits: { type: Number, default: null },
    listedAnnualPriceMinorUnits: { type: Number, default: null },
    listedAnnualDiscountPercent: { type: Number, default: null },
