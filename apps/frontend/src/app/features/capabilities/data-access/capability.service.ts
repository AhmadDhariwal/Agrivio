...
const CURRENT_BEHAVIOR_DEFAULTS: Readonly<Record<string, Readonly<Record<string, boolean>>>> = {
  ...
  // Reports module controls (33 authoritative controls)
  ...
  'reports.reportAvailability.financialPosition': { enabled: true },
  'reports.reportAvailability.dailyCashPosition': { enabled: true },
  'reports.reportAvailability.accountStatement': { enabled: true },
  'reports.reportAvailability.cashBook': { enabled: true },
  'reports.reportAvailability.bankBook': { enabled: true },
  'reports.reportAvailability.accountTransfers': { enabled: true },
  'reports.reportAvailability.treasuryMovements': { enabled: true },
  'reports.reportAvailability.manualAdjustments': { enabled: true },
  'reports.reportAvailability.customerLoans': { enabled: true },
  'reports.reportAvailability.supplierRefunds': { enabled: true },
  'reports.reportAvailability.financialReconciliation': { enabled: true },
  ...
  // Supplier Ledger submodule controls (18 authoritative controls)
  ...
  'payments.supplierLedger.fields.netPayable': { visible: true },
  ...
  'billing.features.currentSubscription': { enabled: true },
  'billing.features.planSelection': { enabled: true },
  'billing.features.billingHistory': { enabled: true },
  'billing.fields.requestedPlan': { visible: true, editable: true },
  'billing.fields.billingPeriod': { visible: true, editable: true },
  'billing.fields.paymentMethod': { visible: true, editable: true },
  'billing.fields.paymentReference': { visible: true, editable: true },
  'billing.fields.amount': { visible: true, editable: true },
  'billing.fields.evidence': { visible: true, editable: true },
  'billing.fields.notes': { visible: true, editable: true },
  'billing.actions.submit': { allowed: true },
  'billing.actions.uploadEvidence': { allowed: true },
